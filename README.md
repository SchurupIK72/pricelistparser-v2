...
---
## Лицензия
(Укажите лицензию, если требуется. Сейчас файл лицензии отсутствует.)

---
## Обратная связь
Добавляйте задачи / пожелания или расширяйте README. Чем детальнее примеры «непонятных» артикулов, тем точнее можно улучшать алгоритм.
